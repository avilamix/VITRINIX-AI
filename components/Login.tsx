...
// Nota: Certifique-se de ter o lucide-react instalado: npm install lucide-react
...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Simulação da chamada para o Backend NestJS
        ...
        <div className="w-full max-w-[400px] space-y-8 bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center">
              <a href="/register" className="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 hover:underline">
